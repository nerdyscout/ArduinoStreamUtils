...
#define STREAMUTILS_PRINT_WRITE_VOID_UINT32 0
    ...
    defined(CORE_TEENSY) || defined(ARDUINO_ARCH_SAMD)
...
#if defined(ARDUINO_ARCH_ESP8266) || defined(ARDUINO_ARCH_ESP32) || defined(ARDUINO_ARCH_SAMD)
...
#if defined(ARDUINO_ARCH_AVR) || defined(CORE_TEENSY) || defined(ARDUINO_ARCH_SAMD)
